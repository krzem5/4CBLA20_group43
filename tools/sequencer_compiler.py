...
ANGLE_TO_ENCODED_PULSE=lambda x:round((500+max(min(x,180),0)*2000/180)/PWM_SEQUENCER_PULSE_ENCODING_FACTOR)
ENCODED_PULSE_TO_ANGLE=lambda x:(x*PWM_SEQUENCER_PULSE_ENCODING_FACTOR-500)*180/2000
